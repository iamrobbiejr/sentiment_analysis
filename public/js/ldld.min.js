...
(function() {
    ...
    ldLoader = function(opt) {
        ...
        ['root', 'container'].map(function(n) {
            if (opt[n]) {
                return (this$[n] = (Array.isArray(opt[n]) ? opt[n] : [opt[n]]).map(
                    function(it) {
                        var ret
    ...
    ldLoader.prototype = import$(Object.create(Object.prototype), {
        ...
        toggle: function(v, delay, force) {
            ...
            return new Promise(function(res, rej) {
                ...
                this$.running = running = this$.root[0].classList.contains(
                    this$.opt.activeClass,
                )
                if (this$.opt.ctrl) {
                    this$.render()
                }
                ...
                if (running) {
                    this$.z = z =
                        ((ref$ = ldLoader.zstack)[ref$.length - 1] || 0) + this$.opt.baseZ
                    this$.root.map(function(it) {
